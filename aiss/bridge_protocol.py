...
# Source: https://github.com/piqrypt/piqrypt/blob/main//home/runner/work/piqrypt/piqrypt/piqrypt/aiss/bridge_protocol.py
    ...
    class PiQryptCallbackHandler(BaseCallbackHandler, BridgeProtocol):
        ...
        def on_tool_start(self, serialized, input_str, **kwargs):
            ...
            if not self.on_action_gate(action):
                raise RuntimeError(
                    f"[AISS] Action '{action.name}' bloquée par TrustGate"
                )
...
_DEFAULT_POLICY_PATH = Path.home() / ".aiss" / "trustgate" / "policy.yaml"
...
class BridgeProtocol:
    ...
    Args:
        ...
        policy_path:   Chemin vers policy.yaml TrustGate (défaut: ~/.aiss/trustgate/policy.yaml)
